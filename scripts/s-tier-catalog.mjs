...
export const TAG_MEDIA = {
  ...
  'vector-db': {
    ...
    blog: L('Stanford IR — vector spaces & dot products', 'https://nlp.stanford.edu/IR-book/html/htmledition/dot-products-1.html'),
...
export const CONCEPT_MEDIA = {
  ...
  'ranking-metrics': { paper: L('NDCG evaluation metric (Järvelin & Kekäläinen)', 'https://doi.org/10.1145/582415.582418') },
  ...
  'search-discovery': { paper: L('TREC: Experiment and Evaluation in IR (Voorhees & Harman)', 'https://arxiv.org/abs/0912.5326'), blog: L('Eugene Yan — ML engineering essays', 'https://eugeneyan.com/writing/') },
  ...
  'context-packing': { paper: L('RULER: Real context size of LLMs (Hsieh et al.)', 'https://arxiv.org/abs/2404.06654') },
  ...
  'ml-tokenization': { paper: L('SentencePiece (Kudo & Richardson)', 'https://arxiv.org/abs/1808.06226'), video: L("Let's build the GPT Tokenizer (Karpathy)", 'https://www.youtube.com/watch?v=zduSFxRajkE') },
  'ml-language-modeling': { paper: L('Language Models are Few-Shot Learners (Brown et al.)', 'https://arxiv.org/abs/2005.14165'), blog: L("Alisa Wuffles — Book of LLMs", 'https://alisawuffles.notion.site/alisa-s-book-of-llms') },
  ...
  'ml-browser-runtime': { paper: L('WebGPU specification (W3C)', 'https://www.w3.org/TR/webgpu/'), blog: L('Karpathy — neural nets basics', 'https://karpathy.github.io/neuralnets/') },
  'ml-webgpu': { paper: L('WebGPU specification (W3C)', 'https://www.w3.org/TR/webgpu/') },
  'ml-evaluation': { paper: L('GLUE: A Multi-Task Benchmark (Wang et al.)', 'https://arxiv.org/abs/1809.07430') },
  'http-lifecycle': { paper: L('RFC 9110 — HTTP Semantics', 'https://www.rfc-editor.org/rfc/rfc9110.html') },
  'api-keys': { paper: L('OAuth 2.0 Bearer Token (RFC 6750)', 'https://www.rfc-editor.org/rfc/rfc6750.html') },
  ...
  'retries-dlq': { paper: L('Harvest, Yield, and Scalable Tolerant Systems (Fox et al.)', 'https://www.usenix.org/legacy/event/osdi99/full_papers/fox/fox.pdf') },
  ...
  'secondary-index': { paper: L('Modern B-Tree Techniques (Graefe)', 'https://research.google/pubs/pub37649/') },
  ...
  replication: { paper: L('Chain Replication (van Renesse et al.)', 'https://www.usenix.org/legacy/event/osdi04/tech/full_papers/renesse/renesse.pdf') },
  ...
  'booking-inventory': { paper: L('F1: A Distributed SQL Database (Shute et al.)', 'https://research.google/pubs/pub38189/') },
  ...
  'location-transport': { paper: L('Contraction Hierarchies (Geisberger et al.)', 'https://arxiv.org/abs/1111.2059') },
  'collaboration-productivity': { paper: L('Operational Transformation (Ellis & Gibbs)', 'https://neil.fraser.name/writing/ot/') },
  'search-platform-design': { paper: L('Bigtable: A Distributed Storage System (Chang et al.)', 'https://research.google/pubs/pub27898/'), blog: L('Eugene Yan — ML engineering essays', 'https://eugeneyan.com/writing/') },
  'rag-system-design': { paper: L('REALM: Retrieval-Augmented Language Model (Guu et al.)', 'https://arxiv.org/abs/2002.08909') },
  ...
  'derivatives-and-gradients': { paper: L('An overview of gradient descent algorithms (Ruder)', 'https://arxiv.org/abs/1609.04747') },
  ...
  'descriptive-statistics': { video: L('StatQuest — Statistics fundamentals', 'https://www.youtube.com/@statquest'), paper: L('MIT 18.650 — Exploratory data analysis', 'https://ocw.mit.edu/courses/18-650-statistics-for-applications-fall-2016/'), book: L('Seeing Theory — Basic Probability', 'https://seeing-theory.brown.edu/basic-probability/index.html') },
  'hypothesis-testing': { video: L('StatQuest — p-values and hypothesis tests', 'https://www.youtube.com/@statquest'), paper: L('MIT 18.650 — Hypothesis testing', 'https://ocw.mit.edu/courses/18-650-statistics-for-applications-fall-2016/'), book: L('Seeing Theory — Frequentist Inference', 'https://seeing-theory.brown.edu/frequentist-inference/index.html') },
  'sampling-and-clt': { paper: L('MIT 18.650 — Central limit theorem', 'https://ocw.mit.edu/courses/18-650-statistics-for-applications-fall-2016/'), book: L('Seeing Theory — Central Limit Theorem', 'https://seeing-theory.brown.edu/probability-distributions/index.html') },
  'covariance-correlation': { paper: L('MIT 18.650 — Covariance and correlation', 'https://ocw.mit.edu/courses/18-650-statistics-for-applications-fall-2016/'), book: L('Seeing Theory — Regression Analysis', 'https://seeing-theory.brown.edu/regression-analysis/index.html') },
  'classical-distributions': { paper: L('MIT 18.650 — Probability distributions', 'https://ocw.mit.edu/courses/18-650-statistics-for-applications-fall-2016/'), book: L('Seeing Theory — Probability Distributions', 'https://seeing-theory.brown.edu/probability-distributions/index.html') },
  'regression-basics': { video: L('StatQuest — linear regression', 'https://www.youtube.com/@statquest'), paper: L('Least-squares regression (MIT 18.650)', 'https://ocw.mit.edu/courses/18-650-statistics-for-applications-fall-2016/'), blog: L('Seeing Theory — Regression Analysis', 'https://seeing-theory.brown.edu/regression-analysis/index.html'), book: L('An Introduction to Statistical Learning', 'https://www.statlearning.com/') },
  ...
  'bias-variance-overfitting': { paper: L('Bias-Variance tradeoff (Geman et al.)', 'https://arxiv.org/abs/0803.3498'), blog: L('Seeing Theory — Frequentist Inference', 'https://seeing-theory.brown.edu/frequentist-inference/index.html'), book: L('An Introduction to Statistical Learning', 'https://www.statlearning.com/') },
  ...
  'random-walks-markov': { video: L('Harvard Stat 110 — Markov chains', 'https://www.youtube.com/playlist?list=PL2SOU6wwxB0v4vJLp4i3MtA7WFTObS8Jg'), paper: L('The PageRank Citation Ranking (Brin & Page)', 'https://snap.stanford.edu/class/cs224w-readings/Brin98Anatomy.pdf'), blog: L('Harvard Stat 110 course site', 'https://projects.iq.harvard.edu/stat110/home'), book: L('Introduction to Probability (Blitzstein & Hwang)', 'https://projects.iq.harvard.edu/stat110/home') },
  ...
  'customer-obsession': { paper: L('Customer satisfaction meta-analysis (Szymanski & Henard)', 'https://psycnet.apa.org/doiLanding?doi=10.1037/0021-9010.84.2.310'), blog: L('SVPG — customer discovery', 'https://www.svpg.com/articles/') },
  'ownership-and-accountability': { paper: L('On the criteria for decomposing systems into modules (Parnas)', 'https://doi.org/10.1145/362486.362498'), blog: L('Google SRE — Embracing risk', 'https://sre.google/sre-book/embracing-risk/') },
  positioning: {

...
const ROADMAP_DEFINITIONS = [
  ...
  },
  {
    ...
    groups: [
      ...
      ['messaging-realtime', 'game-design', 'interactive-2d-3d-systems'],
  ...
  categories: [
    ...
    },
    {
      ...
      topics: [
        ...
        topic('Observability and OpenTelemetry', ['monitoring-analytics']),
    ...
    },
    {
      ...
      topics: [
        ...
        topic('Real-time applications', ['messaging-realtime']),

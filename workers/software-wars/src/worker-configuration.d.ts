/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/software-wars/wrangler.jsonc workers/software-wars/src/worker-configuration.d.ts` (hash: cbc2745dad3baeac8d6dcba754230e5b)
// Runtime types generated with workerd@1.20260722.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	WAR_ARTIFACTS: R2Bucket;
	DB: D1Database;
	WAR_JOBS: Queue;
	ENVIRONMENT: "production";
	PAGES_ORIGIN: "https://swe-interview-prep.pages.dev";
	TRADEOFF_MATCH: DurableObjectNamespace<import("./index").TradeoffMatch>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "TradeoffMatch";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PAGES_ORIGIN">> {}
}

...
export default function Onboarding() {
  ...
  return (
    <div
      className={`mx-auto w-full px-6 py-16 ${step === 0 ? 'max-w-4xl' : 'max-w-3xl'} ${step === 0 ? '' : 'flex min-h-[70vh] flex-col justify-center'}`}
    >
      ...
      {step === 0 && (
        <>
          ...
          <h1 className="mt-3 text-3xl font-bold text-white sm:text-4xl">
            Pick your primary path.
          </h1>
          <p className="mt-3 max-w-prose text-sm text-white/50">
            Optional — sizes Today&apos;s session to your schedule and picks a default roadmap. The
            full catalog stays open at Explore without finishing this.
          </p>
      ...
      {step === 1 && (
        <>
          ...
          <p className="mt-3 text-sm text-white/50">
            Sessions are packed to fit your day — no infinite queues.
          </p>
          ...
          <div className="mt-8">
            <label className="text-xs font-medium text-white/40">
              Interview horizon (optional, days)
            </label>
            <input
              type="number"
              min={1}
      ...
      {step === 2 && (
        <>
          ...
          <p className="mt-3 text-sm text-white/50">
            Rough split for a typical {minutes}-minute day. Adjust anytime in Settings.
          </p>

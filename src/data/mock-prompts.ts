...
export const MOCK_PROMPTS: MockPrompt[] = [
  ...
  },
  {
    ...
    rubric: [
      ...
      'Compares heap alternative with tradeoffs',
      'States time/space clearly',
    ],
  ...
  },
  {
    ...
    rubric: [
      ...
      'Handles diagonal vs 4-direction connectivity',
      'Streaming / external memory extension',
    ],
    conceptIds: ['graphs'],
  },
  {
    id: 'mock-dp-house-robber',
    kind: 'technical',
    ...
    rubric: [
      ...
      'Circular variant called out as two-pass',
      'Tests edge cases (0, 1 houses)',
    ],
    conceptIds: ['dp-1d'],
  },
];

...
export interface NodeConfig {
  /** Scale extension: route a partition dispatcher by key instead of balancing requests. */
  partitionRouting?: boolean;
  /** Scale extension: preserve primary write contention in a replica set. */
  primaryLockMs?: number;
  /**
